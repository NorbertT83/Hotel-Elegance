...
export const bookingPageText = {
    hu: {
        ...
        step4: {
            header: 'Összegző',
            description: 'Eddig választott opciói alapján kalkulált végösszeg',
            prevButton: 'Vissza',
            nextButton: 'Tovább',
            champagne: 'Pezsgő bekészítés',
            transfer: 'Repülőtéri transzfer',
    ...
    en: {
        ...
        step4: {
            header: 'Summary',
            description: 'Total amount calculated based on the options you have selected so far',
            prevButton: 'Back',
            nextButton: 'Next',
            champagne: 'Champagne setup',
            transfer: 'Airport transfer',
        ...
        guestPage: {
            ...
            menuOverview: {
                ...
                roomCard: {
                    ...
                    DND_on: "DND be",
                    DND_off: "DND ki",
                    needsCleaning: "Takarítás",
                    needsCleaning_on: "Igényelve",
                    needsCleaning_off: "Igénylés",
                },
                serviceCard: {
        ...
        guestPage: {
            ...
            menuOverview: {
                ...
                roomCard: {
                    ...
                    DND_on: "DND On",
                    DND_off: "DND Off",
                    needsCleaning: "Extra cleaning",
                    needsCleaning_on: "Requested",
                    needsCleaning_off: "No need",
                },
                serviceCard: {
